  ...
  >
    <div class="flex items-center justify-between mb-2">
      <div class="flex items-center gap-3">
        <div
          class="bg-gray-300 text-white text-sm font-semibold w-10 h-10 flex items-center justify-center rounded-full"
        >
          {{ initials }}
        </div>
        <div>
    ...
    <div
      class="flex items-center gap-1 text-xs text-green-600 font-medium mt-3"
    >
      <svg
      ...
      >
        <path
          d="M16.707 5.293a1 1 0 010 1.414L8.414 15 4 10.586a1 1 0 011.414-1.414L8.414 13.172l7.293-7.293a1 1 0 011.414 0z"
        />
      </svg>

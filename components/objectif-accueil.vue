  ...
  <section class="bg-black text-white py-16 px-4">
    ...
    <div class="max-w-7xl mx-auto text-center mb-10">
      ...
      <p class="text-gray-300 mb-6 max-w-3xl mx-auto">
        Les Objectifs de Trading sont basés sur les principes fondamentaux de la
        gestion des risques. Une fois atteints lors du Challenge et de la
        Vérification, les clients deviennent AKAD Trader.
      </p>
      ...
      <div class="flex flex-wrap justify-center items-center gap-4 mb-6">
        ...
        <div class="flex items-center gap-2">
          <button
            class="px-4 py-2 bg-yellow-400 text-black font-bold rounded"
    ...
    <transition name="fade" mode="out-in">
      ...
      <div v-if="!showComparison" key="normal" class="max-w-5xl mx-auto">
        <div class="bg-zinc-900 rounded-lg overflow-hidden text-sm text-white">
          <div
            class="grid grid-cols-4 text-center bg-zinc-800 font-bold text-yellow-400"
          >
          ...
          <div
            v-for="row in rows"
            :key="row.label"
            class="grid grid-cols-4 border-t border-zinc-700 text-center hover:bg-zinc-800"
          >
          ...
          <table class="min-w-full text-white text-sm border-collapse">
            ...
            <tbody>
              <tr
                v-for="row in rows"
                :key="row.label"
                class="border-t border-zinc-700 hover:bg-zinc-800"
              >
  ...
  const values = [
    {
      ...
      max: 1000,
      profit: 1000,
      fee: cur === 'USD' ? 79 : cur === 'EUR' ? 89 : 79,
    },
    {
      maxDay: 1250,
      max: 2500,
      profit: 2500,
      fee: cur === 'USD' ? 199 : cur === 'EUR' ? 199 : 199,
    },

...
const certificates = [
  {
    ...
    description: 'Certificat prouvant la réussite du Challenge AKAD sur un compte 10,000€',
    date: '14 avril 2025',
        ...
        <div class="bg-zinc-900 p-6 rounded-2xl shadow-lg">
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div
              ...
              :key="index"
              :class="[ 'relative p-5 border rounded-xl transition',
                certif.status === 'valid' ? 'bg-zinc-800 border-zinc-700 hover:shadow-xl' : 'bg-zinc-800 border-zinc-700 opacity-50 pointer-events-none blur-[1px]' ]"
            >
          ...
          <div v-if="certificates.length === 0" class="text-center text-gray-400 mt-10">

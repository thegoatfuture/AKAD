    ...
    <div class="max-w-5xl mx-auto space-y-10">
      ...
      <header class="text-center">
        ...
        <p class="text-gray-400 mt-2">
          Profitez d'une expérience évoluée et d'avantages exclusifs
        </p>
      </header>
      ...
      <section class="bg-zinc-900 rounded-2xl shadow-lg p-8">
        ...
        <ul
          class="grid md:grid-cols-2 gap-4 text-sm text-gray-300 list-disc list-inside"
        >
      ...
      <section class="bg-zinc-900 rounded-2xl shadow-lg p-8">
        ...
        <div
          class="flex flex-col md:flex-row justify-between text-sm text-gray-300 gap-4"
        >
          <div class="flex-1">
